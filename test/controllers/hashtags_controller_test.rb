...
class HashtagsControllerTest < ActionController::TestCase
  ...
  test "should create hashtag" do
    assert_difference('Hashtag.count') do
      post :create, hashtag: { discount: @hashtag.discount, permalink_url: @hashtag.permalink_url, user_id: @hashtag.user_id }
    end
  ...
  test "should update hashtag" do
    patch :update, id: @hashtag, hashtag: { discount: @hashtag.discount, permalink_url: @hashtag.permalink_url, user_id: @hashtag.user_id }
    assert_redirected_to hashtag_path(assigns(:hashtag))
  end
